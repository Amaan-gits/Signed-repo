...
public class PermissionManagerActivity extends AppCompatActivity {
    ...
    private void logSpecialPermissionStatus() {
        ...
        Log.d(TAG, "Overlay: " +
                (Settings.canDrawOverlays(this) ? "GRANTED" : "DENIED"));

        Log.d(TAG, "Battery Optimization: " +
                (isIgnoringBatteryOptimizations() ? "GRANTED" : "DENIED"));

        Log.d(TAG, "Notification Listener: " +
                (isNotificationListenerEnabled() ? "GRANTED" : "DENIED"));
    ...
    private void showFullPermissionStatus() {
        ...
        for (String perm : runtimePermissions) {
            ...
            status.append(name)
                    .append(" : ")
                    .append(res == PackageManager.PERMISSION_GRANTED ? "✅" : "❌")
                    .append("\n");
        ...
        status.append("Usage Stats : ")
                .append(hasUsageStatsPermission() ? "✅" : "❌")
                .append("\n");

        status.append("Overlay : ")
                .append(Settings.canDrawOverlays(this) ? "✅" : "❌")
                .append("\n");
        ...
        status.append("Notification Listener : ")
                .append(isNotificationListenerEnabled() ? "✅" : "❌")
                .append("\n");
